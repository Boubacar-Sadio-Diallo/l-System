...
public class Demo {
	...
	public static void main(String[] args) {
		...
		LinkedList<Symbole> evoluerTest=new LinkedList<Symbole>();
		...
		LinkedList<Symbole> testGene = new LinkedList<Symbole>();
		testGene.add(effe);
		testGene.add(plus);
		LinkedList<Symbole> AutreevoluerTest=new LinkedList<Symbole>();
